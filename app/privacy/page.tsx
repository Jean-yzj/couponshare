...
export default function PrivacyPage() {
  return (
    <div className="mx-auto max-w-2xl pb-12">
      ...
      <p className="mt-1.5 text-sm text-ink-faint">生效日期：2026 年 8 月 6 日</p>
      ...
      <div className="mt-7 space-y-6">
        ...
        <Clause n="三" title="個人資料之提供與揭露">
          ...
          <p>
            3.4 官方福利券（品牌合作內容）：當您申請合作品牌之官方福利券時，您的顯示名稱、申請留言、申請狀態及申請時間，
            將提供予該合作品牌，僅供其審核申請及提供優惠之用；本平台以契約限制品牌不得將該資料用於行銷或其他目的，
            且檔期結束後應予刪除。
          </p>
        </Clause>
        ...
        <Clause n="五" title="個人資料之保存期間與帳號刪除">
          <p>5.1 本平台於達成蒐集目的所必要之期間內保存您的個人資料。</p>
          <p>
            5.2 您得隨時於本服務內刪除您的帳號。帳號刪除後，本平台將立即清除您的電子郵件地址、密碼、
            第三方登入識別碼及大頭貼影像，並將您的顯示名稱改為「已刪除的使用者」；您上架中之票券亦同時下架。
          </p>
          <p>
            5.3 為第二條 (d)、(e) 所載之詐欺防制與爭議處理目的，並供行使或防禦法律上之請求，
            下列資料於帳號刪除後仍保留一定期間：
          </p>
          <p className="pl-4">(a) 交易紀錄，包括票券資訊、交易時間及交易狀態；</p>
          <p className="pl-4">
            (b) 交易對話紀錄。該等對話同時為交易相對人之紀錄，涉及其權益，故不因單方刪除帳號而移除；
          </p>
          <p className="pl-4">
            (c) 系統稽核日誌，包括帳號刪除前之電子郵件地址、各次操作之時間及來源 IP 位址。
          </p>
          <p>
            5.4 前項資料自帳號刪除之日起保留<strong>六個月</strong>。期滿後，本平台將清除其中足資識別特定個人之欄位
            （電子郵件地址、IP 位址、裝置識別字串），僅保留無從識別特定個人之交易紀錄。
          </p>
          <p>
            5.5 帳號如涉及尚未終結之檢舉、申訴、交易爭議，或涉及司法、行政機關之調查或訴訟程序者，
            前條資料保留至該事件終結為止，不受六個月之限制。
          </p>
          <p>5.6 法令另有規定者，從其規定。</p>
        </Clause>
        ...
        <Clause n="六" title="您的權利">
          ...
          <p>
            惟依個人資料保護法第十一條第三項但書，因執行業務所必須者，本平台得繼續保存部分資料。
            具體而言，第五條 5.3 至 5.5 所列之交易紀錄、對話紀錄及稽核日誌，於各該所定期間內
            不因您行使刪除權而移除；該等資料僅供詐欺防制、爭議處理及法律上請求之行使或防禦，
            不作其他利用。
          </p>
        </Clause>
