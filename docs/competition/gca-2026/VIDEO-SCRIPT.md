...
成品長度：55.2 秒。旁白使用保留音高的 2 倍速；畫面定格，避免數位推鏡跳動。影片使用正式站操作畫面與品牌主視覺，不露出書籤列、其他分頁、通知、終端機或個人帳號資訊。
...
- 解析度 1920×1080，30 fps；2 倍旁白、保留音高。
- 不在影片中輸入或顯示評審帳號密碼。
- 不點擊「送出申請」、不消耗真實票券。
- 已確認成品為 H.264/AAC、55.2 秒，並抽查開頭、中段與結尾畫面。
